...
Rectangle{
    ...
    Slider {
        ...
        onValueChanged: {
            ...
            cvController.drawShape(_root.cannyThres, _root.colorType, _root.shapeId)
    ...
    Column {
        ...
        spacing: 10
        Repeater{
            model: [{name: "Rectangle"},{name: "Circle"},{name: "Rotated Rec"}, {name: "Ellipse"}]
            delegate: Button{
                text: modelData.name
                font.pixelSize: 12
                background: Rectangle {
                            ...
                            implicitHeight: 40
                            radius: 8
                            color: index === _root.shapeId ? "#44aaff" : "white"
                            border.color: "#222"
                            border.width: 1
                        }
