...
Rectangle{
    ...
    property int contour: 2
    Text{
        id: label
        anchors.horizontalCenter: parent.horizontalCenter
        anchors.top: parent.top
        anchors.topMargin: 15
        text: "Point Polygon Test"
        font.pixelSize: 16
    }
    Slider {
        id: canny_thres
        ...
        onValueChanged: {
            ...
            cvController.point_test(_root.cannyThres, _root.contour)
    ...
    Row {
        ...
        spacing: 10
        Repeater{
            model: [{name: "Fisrt One"},{name: "Last One"},{name: "Biggest One"}, {name: "Smallest One"}, {name: "RANDOM"}]
            delegate: Button{
                text: modelData.name
                font.pixelSize: 12
                background: Rectangle {
                            ...
                            implicitHeight: 40
                            radius: 8
                            color: index === _root.contour ? "#44aaff" : "white"
                            border.color: "#222"
                            border.width: 1
                        }
