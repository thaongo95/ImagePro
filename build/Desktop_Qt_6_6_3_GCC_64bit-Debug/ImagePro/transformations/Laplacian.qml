...
Rectangle{
    ...
    Row {
        ...
        spacing: 10
        Repeater{
            model: [{name: "1x1", value: 1},{name: "3x3", value: 3},
            {name: "5x5", value: 5},{name: "7x7", value: 7}]
            delegate: Button{
                id: typeBt
                text: modelData.name
                font.pixelSize: 12
                ...
                onClicked:{
                    ...
                    cvController.laplace( _root.ksize ,_root.scale, _root.delta)
